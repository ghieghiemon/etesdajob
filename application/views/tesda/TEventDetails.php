     ...
     <div class="row-fluid">
    	<div class="span12">
            ...
            <h3 class="media-heading">
                ...
                <a href="TEventsAll.html" class="Comm"> 
                	Events
                </a>
            </h3>
            ...
            <div class="row-fluid">
              	<div class="span11">
                	<div class="well" style="margin-left:120px;">
                        ...
                        <p class="evAttendees">Attendees (12)</p>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="assets/img/user.png" alt="" class="attendeesPic">
                                     <p class="attendeeName">Angelica Guerrero</p>
                                </td>
                                
                                <td>
                                	 <img src="assets/img/user2.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Dyanne Ocampo</p>
                                </td>
                                
                                <td>
                                     <img src="assets/img/user3.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Jason Montes</p>
                                </td>
                                
                                <td>
                                     <img src="assets/img/user4.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Miguel Ortega</p>
                                </td>
                             </tr> <!--one row-->
                             
                             <tr>
                                <td>
                                     <img src="assets/img/user5.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Ronaldo Laudico</p>
                                </td>
                                
                                <td>
                                	 <img src="assets/img/user6.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Ronaldo Gomez</p>
                                </td>
                                
                                <td>
                                     <img src="assets/img/user7.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Margarette Medina</p>
                                </td> 
                                
                                <td>
                                     <img src="assets/img/user8.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Josh Boutwood</p>
                                </td>
                             </tr> <!--one row-->
                             
                             <tr>
                                <td>
                                     <img src="assets/img/user9.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Matthew Go</p>
                                </td>
                                
                                <td>
                                	 <img src="assets/img/user10.png" alt="" class="attendeesPic">
                                     <p class="attendeeName">Bernadine Ramirez</p>
                                </td>
                                
                                <td>
                                     <img src="assets/img/user12.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Heny Sison</p>
                                </td>
                                
                                <td>
                                     <img src="assets/img/user11.jpg" alt="" class="attendeesPic">
                                     <p class="attendeeName">Gerald Dela Cruz</p>
                                </td>
                             </tr> <!--one row-->
                        </tbody>
                    </table><!--end table-->
