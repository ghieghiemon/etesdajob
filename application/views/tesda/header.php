     ...
     <div class="navbar navbar-inverse navbar-fixed-top"> <!--start body code-->
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav" style="margin-left:100px;margin-top:-2px;">
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                	<img src="<?php echo base_url()?>assets/bootstrap/img/TESDA.jpg" width="25" height="20" style="margin-left:-11px;"> TESDA
                                    <b class="caret"></b>
                                </a>
