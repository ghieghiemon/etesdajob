    	...
    	<div class="span12">
        	<div class="well">
                ...
                <div style="width:1200px;height:470px;overflow:auto;"><!--start scrollable table-->     
                       <form method="post" action="<?php echo base_url()?>employer/invite_league/<?php echo $leagueno?>">
                      <div align="right">
                	<button type ="submit" class="btn btn-primary" >Invite</button>
                    </div>
                    <br>
                      <table id ="league" class="tableInv table-hover table-condensed table-striped">
                      <thead>
                          <tr>
