                ...
                <div align="left" class="legendMarg">
                	<h4 style="margin-left:40px;">
                        ...
                        <font class="legendFont">
                        	<img src="assets/img/icons/glyphicons_049_star.png" width="15"> - Invited 
                        </font>
                    </h4>
                ...
                <hr class="hrDicussBigA">
                   ...
                   <div class="tabbable"> <!-- start tabs-->
                      <ul class="nav nav-tabs">
                          <li class="active"><a href="#tab1" data-toggle="tab">Unscreened</a></li>
                          ...
                          <li><a href="#tab4" data-toggle="tab">Requirements</a></li>
                          <li><a href="#tab4" data-toggle="tab">Hire</a></li>
                      </ul>
