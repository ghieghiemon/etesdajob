        	...
        	<div class="well">
            	<div class="row-fluid">
                	<div class="span11">
                    	...
                    	<table style="margin-left:10px;">
                            ...
                            <tbody>
                            	...
                            	<tr>
                                    ...
                                    <td>
                                    	<p class="lDetMarg">
                                        <img src="<?php echo base_url()?>assets/bootstrap/img/<?php echo $a['sectorIcon']?>" class="LeagueInIcon pull-right" alt="Auto Industry"><img src="<?php echo base_url()?>assets/bootstrap/img/icons/glyphicons_043_group.png"><a href="ELeagues.html" class="LeaName"><?php echo $a['leaguename']?></a>
                                        </p>
                        ...
                        {
                        ?>
                        <form accept-charset="UTF-8" action="<?php echo base_url()?>employer/posttopic/<?php echo $a['leagueno']?>" method="POST" class="form-horizontal" style="margin-left:10px; margin-bottom:5px;">
                        <?php
                        }
                        ?>
                	...
                	<div class="span12">
                        ...
                        <ul class="nav nav-list">
                            ...
                            <li style="margin-left:30px;">
                                <a href="<?php echo base_url()?>employer/view_topic/<?php echo $a['discussionno']?>" class="DisTitle2">
                                ...
                                <font style="margin-left:50px;">
                                    ...
                                    | <a href="#" class="Name3">
                                    <?php 
                                     $replies = $this->model_employer->get_discReplies($a['discussionno']);
                                    echo count($replies);
                                     if(count($replies) <=1 )
                                         echo " reply";
                                     else echo " replies";
